...
SECRET_KEY = '98*wqnw(gsxhsym%_l68_t4l%c6w3+9!+kz(rfgxj!kfkh*kvh'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [u'soycruzmery.pythonanywhere.com']
...
#MEDIA_ROOT = u'/home/soycruzmery/mysite/media'
#MEDIA_URL = '/media/'
STATIC_ROOT = u'/home/soycruzmery/mysite/static'
STATIC_URL = '/static/'
MEDIA_URL = '/media/'
